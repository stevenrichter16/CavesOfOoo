...
function handleDebugGameControls(STATE, e, k) {
  console.log("in handleDebugGameControls");
  if (k.toLowerCase() === "m") {
...
function handleInventoryControls(STATE, e) {
  ...
  console.log("in handleInventoryControls");
...
function handleMapControls(STATE, e) {
  console.log("in handleMapControls");
...
function handleQuestTurnInControls(STATE, e) {
  console.log("in handleQuestTurnInControls");
...
function handleShopControls(STATE, e) {
  console.log("in handleShopControls");
